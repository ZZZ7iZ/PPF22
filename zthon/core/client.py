                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @H_M_Dr\
                                  \n\n--------بـدء تتبـع سجـل ســبـارك 𝚂𝙿𝙰𝚁𝙺--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ســبارك 𝚂𝙿𝙰𝚁𝙺--------"
                        ...
                        link = "[𝚂𝙿𝙰𝚁𝙺(https://t.me/H_M_Dr)"
                        text = (
                            "**✘ تقـريـر اشعـار ســبارك 𝚂𝙿𝙰𝚁𝙺 ✘**\n\n"
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  \n\nنسجل فقـط تقريـر الإشعـار وتـاريخـه ،\
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @ZZZ7iZ\
                                  \n\n--------بـدء تتبـع سجـل ســبارك  𝚂𝙿𝙰𝚁𝙺--------\
                                  \n- التـاريـخ : {date}\n- ايـدي الكـروب : {str(check.chat_id)}\
                                  \n- ايـدي الشخـص : {str(check.sender_id)}\
                                  \n- رابـط الرسـالـه : {await check.client.get_msg_link(check)}\
                                  \n\n- التقـريـر :\n{str(check.text)}\
                        ...
                        text = "**✘ تقـريـر اشعـار ســبارك 𝗧𝗘𝗣𝗧𝗛𝗢𝗡 ✘**\n\n "
                        link = "[𝚂𝙿𝙰𝚁𝙺(https://t.me/ZZZ7iZ)"
