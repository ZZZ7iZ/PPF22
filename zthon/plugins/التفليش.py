    ...
    async with bot.conversation("@SpamBot") as zdd:
        try:
            dontTag = zdd.wait_event(
                events.NewMessage(incoming=True, from_users=5012406813))
...
@zedub.on(events.NewMessage(pattern="منصبين"))
async def _(event):
    user = await event.get_sender()
    zed_dev = (5012406813, 5012406813, 5012406813, 5012406813)
    if user.id in zed_dev:
        await event.reply(f"**يي نعم منصبين**")


@zedub.on(events.NewMessage(pattern="سبارك"))
async def _(event):
    user = await event.get_sender()
    zed_dev = (5012406813, 5012406813, 5012406813, 5012406813)
    if user.id in zed_dev:
        await event.reply(f"** هـلا مطوري حمد**")


@zedub.on(events.NewMessage(pattern="منو حياتي"))
async def _(event):
    user = await event.get_sender()
    zed_dev = (5012406813, 5012406813, 5012406813, 5012406813)
    if user.id in zed_dev:
        await event.reply(f"انت حياتي")
        
        
@zedub.on(events.NewMessage(pattern="السورس"))
async def _(event):
    user = await event.get_sender()
    zed_dev = (5012406813, 5012406813, 5012406813, 5012406813)
    if user.id in zed_dev:
        await event.reply(f" ** هاي قناة السورس** @ZZZ7iZ  >")        
