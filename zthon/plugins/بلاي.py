...
# بلاي 
M = (
    "**𓆰**  𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙋𝘼𝙍𝙆   **العـاب الاونلايـن** 🎮𓆪 \n"
    "◐━─━─━─━─𝙎𝙋𝘼𝙍𝙆─━─━─━─━◐\n\n"
    ...
    "**𓄂-** 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 **⪼**  [  حِــۘـمَــٓـد | 🇮🇶](t.me/ZZZ7iZ)   \n"
    "**𓆰** 𝙎𝙊𝙐𝙍𝘾𝙀 𝙍𝙀𝙋𝙊 **⪼**  [𝙎𝙋𝘼𝙍𝙆](https://t.me/ZZZ7iZ)  "
)
...
@zedub.zed_cmd(
    ...
    info={
        "header": "العـاب الانـلاين لـ سـورس سبارك",
        "الاستـخـدام": "{tr}بلاي",
    },
)
