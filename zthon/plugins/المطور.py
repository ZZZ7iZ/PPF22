...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝙎𝙋𝘼𝙍𝙆 𓆪 </b> - @ZZZ7iZ "
...
async def who(event):
    ...
    if replied_user.id in zel_dev:
       return await edit_or_reply(zed, "**- عذرًا . . اني احـد المطـورين . . عيب**")
    if replied_user.id == 5012406813 or replied_user.id == 5012406813 or replied_user.id == 5012406813:
       return await edit_or_reply(zed, "**- عذرًا . . اني المطـور . . عيب**")
