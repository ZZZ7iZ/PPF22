...
ZThon - ZelZal
- كتـابـة الاضـافـات
زلــزال الـهيبــه - @H_M_Dr
- حقـوق زدثـــون @ZZZ7iZ
...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت سبارك"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𝙎𝙋𝘼𝙍𝙆 ─┄─┄─┄─⋆"
zed_dev = (5012406813, 5012406813)
zel_dev = (5012406813, 5012406813)
zelzal = (5012406813, 5012406813)
