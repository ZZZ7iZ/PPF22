    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                "https://graph.org/file/0dc4d88e3ac88073d5f85.jpg",
                
                caption="**•⎆┊تـم بـدء تشغـيل سـورس سبارك الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙿𝙰𝚁𝙺", "https://t.me/ZZZ7iZ"),)],
...
zthon = {"@ZZZ7iZ", "@JZIXl", "@ZCALIPHZ", "@W_7_WI", ""}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            ...
            "كـروب السجلات", zedub, Config.TG_BOT_USERNAME, descript, photozed
